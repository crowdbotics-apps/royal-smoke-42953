"""
Django settings for royal_smoke_42953 project.
...
ROOT_URLCONF = 'royal_smoke_42953.urls'
...
WSGI_APPLICATION = 'royal_smoke_42953.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_smoke_42953 API",
    "DESCRIPTION": "API documentation for royal_smoke_42953 App",
    "VERSION": "v1",
}
